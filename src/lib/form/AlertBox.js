...
function AlertBox({title, description, marginTop, border, titleColor,backgroundColor}) {
  return (
    <Alert border={border} marginTop={marginTop} backgroundColor={backgroundColor}>
